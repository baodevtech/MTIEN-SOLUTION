          ...
          <div className="md:col-span-6 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            >
              ...
              <div className="flex flex-row items-center justify-center md:justify-start gap-3 md:gap-4 mb-0 md:mb-10">
                <button className="bg-[#0066FF] hover:bg-blue-700 text-white rounded-full px-5 md:px-8 py-2.5 md:py-3.5 flex items-center justify-center gap-2 md:gap-3 shadow-xl shadow-[#0066FF]/30 transition-all transform hover:scale-[1.02] active:scale-[0.98]">
                  <span className="font-semibold text-[13px] md:text-[16px]">Bắt đầu dùng thử</span>
                  <ArrowRight size={15} strokeWidth={2.5} aria-hidden="true" />
                </button>
                
                <button className="bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-full px-5 md:px-8 py-2.5 md:py-3.5 flex items-center justify-center gap-2 md:gap-3 shadow-sm transition-all shadow-black/5 hover:shadow-black/10">
                  <Play size={15} className="fill-slate-700" />
                  <span className="font-semibold text-[13px] md:text-[16px]">Xem demo</span>
                </button>
              </div>

              {/* Desktop social proof — stays here */}
            ...
            <div className="md:hidden w-full mt-5 flex flex-col gap-4">
              ...
              <div className="flex flex-row items-center justify-center gap-3 pt-3">
                <div className="flex -space-x-2">
                  ...
                  <div className="w-8 h-8 rounded-full border-2 border-white bg-slate-100 flex items-center justify-center text-[9px] font-bold text-slate-600 shadow-sm z-10">
                    230k+
                  </div>
                </div>
                <div>
                  ...
                  <p className="text-[12px] font-medium text-slate-600"><span className="font-semibold text-slate-900">10,000+</span> doanh nghiệp</p>
                </div>
              </div>
            </div>
          </div>
