...
export default function Footer() {
  return (
    <footer className="bg-[#0a0f1a] text-gray-400 pt-10 md:pt-16 pb-6 md:pb-8 border-t border-gray-800 text-[11px] md:text-sm" role="contentinfo">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 pt-6 md:pt-8 border-t border-gray-800">
          <div>
