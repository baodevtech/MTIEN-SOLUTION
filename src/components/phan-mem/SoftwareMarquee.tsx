          ...
          <div key={set} className="flex items-center">
            {['Thiết Kế Website', 'Lập Trình App Mobile', 'Phần Mềm ERP', 'Kiểm Thử Phần Mềm', 'Bảo Mật Server'].map((text, idx) => (
              <div key={idx} className="flex items-center mx-[20px] md:mx-[40px] group">
                <img src="https://inotek.themevally.com/wp-content/uploads/2025/11/hm3-icon1.png" alt="icon" className="w-[16px] h-[16px] md:w-[30px] md:h-[30px] mr-1.5 md:mr-4 group-hover:rotate-12 transition-transform" />
