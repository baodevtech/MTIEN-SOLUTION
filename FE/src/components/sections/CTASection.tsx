        ...
        <div className="flex flex-col items-center text-center">
          <div className="max-w-2xl">
            <h2 className="text-[22px] md:text-[44px] font-semibold text-[#1D1D1F] tracking-tight leading-tight mb-3 md:mb-4">
              {t('title', 'Khởi đầu mới.')} <span className="text-slate-400">{t('titleHighlight', 'Ngay hôm nay.')}</span>
            </h2>
            <p className="text-[#86868B] text-[13px] md:text-[18px] mb-6 md:mb-10 tracking-tight font-medium">
              {t('description', 'Dùng thử miễn phí 7 ngày. Thiết lập cửa hàng chỉ trong vài phút.')}
            </p>
          </div>
          ...
          <div className="w-full max-w-lg">
            <form className="relative bg-white p-1.5 md:p-1.5 rounded-full shadow-sm flex items-center border border-slate-200" action="#">
              ...
              <input
                id="cta-website-name"
                type="text"
                placeholder={t('placeholder', 'Tên website của bạn...')}
          ...
          <div className="mt-4 md:mt-8 flex items-center gap-3 md:gap-5 text-[10px] md:text-[12px] font-bold text-slate-400 uppercase tracking-widest">
            <span className="flex items-center gap-1">
              <CheckCircle2 size={12} className="text-emerald-500" aria-hidden="true" /> {t('trustBadge1', 'No credit card')}
            </span>
            <span className="w-1 h-1 bg-slate-200 rounded-full" aria-hidden="true"></span>
            <span className="flex items-center gap-1">
              <CheckCircle2 size={12} className="text-emerald-500" aria-hidden="true" /> {t('trustBadge2', 'Setup in 5 mins')}
            </span>
          </div>
        </div>
      </div>
