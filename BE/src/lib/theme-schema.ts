    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'milestones', label: 'Các cột mốc', type: 'repeater', fields: [
          ...
          { key: 'color', label: 'Màu (Tailwind class)', type: 'text' },
          { key: 'rotate', label: 'Độ xoay (Tailwind class)', type: 'text' },
        ], defaultValue: [
          { year: '2016', title: 'Thành lập công ty', desc: 'Khởi đầu với đội ngũ 5 thành viên đam mê công nghệ.', color: 'bg-yellow-100 text-yellow-900', rotate: 'rotate-[-2deg] md:rotate-[-3deg]' },
          { year: '2018', title: 'Mở rộng quy mô', desc: 'Đạt mốc 100 khách hàng doanh nghiệp đầu tiên.', color: 'bg-emerald-100 text-emerald-900', rotate: 'rotate-[1deg] md:rotate-[2deg]' },
          { year: '2020', title: 'Giải thưởng Top IT', desc: 'Được vinh danh trong top các công ty công nghệ triển vọng.', color: 'bg-rose-100 text-rose-900', rotate: 'rotate-[-1deg]' },
          { year: '2023', title: 'Chuyển đổi số toàn diện', desc: 'Ra mắt hệ sinh thái giải pháp doanh nghiệp thế hệ mới.', color: 'bg-blue-100 text-blue-900', rotate: 'rotate-[2deg] md:rotate-[3deg]' },
        ]},
      ],
    },
    {
