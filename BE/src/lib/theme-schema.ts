  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'badgeColor', label: 'Màu badge', type: 'color', defaultValue: '#FF6B00' },
        { key: 'title', label: 'Tiêu đề', type: 'text', defaultValue: 'Định hình tương lai qua Đổi mới Công nghệ' },
        { key: 'titleGradientFrom', label: 'Gradient tiêu đề từ', type: 'color', defaultValue: '#0066FF' },
        { key: 'titleGradientTo', label: 'Gradient tiêu đề đến', type: 'color', defaultValue: '#00D68F' },
        { key: 'description', label: 'Mô tả', type: 'textarea', defaultValue: 'Từ năm 2016, MTIEN Solution đã tiên phong trong việc cung cấp giải pháp công nghệ đột phá, giúp hàng nghìn doanh nghiệp Việt Nam chuyển đổi số thành công.' },
        { key: 'bgImage', label: 'Ảnh nền', type: 'image', defaultValue: '' },
      ],
    },
    {
      ...
      defaultVisible: true,
      fields: [
        { key: 'visionTitle', label: 'Tiêu đề tầm nhìn', type: 'text', defaultValue: 'Tầm nhìn' },
        { key: 'visionText', label: 'Nội dung tầm nhìn', type: 'textarea', defaultValue: 'Trở thành tập đoàn công nghệ hàng đầu khu vực...' },
        { key: 'visionBgColor', label: 'Màu nền tầm nhìn', type: 'color', defaultValue: '#0066FF' },
        { key: 'visionImage', label: 'Ảnh tầm nhìn', type: 'image', defaultValue: '' },
        { key: 'missionTitle', label: 'Tiêu đề sứ mệnh', type: 'text', defaultValue: 'Sứ mệnh' },
        { key: 'missionText', label: 'Nội dung sứ mệnh', type: 'textarea', defaultValue: 'Trao quyền cho doanh nghiệp thông qua các giải pháp công nghệ...' },
        { key: 'missionBgColor', label: 'Màu nền sứ mệnh', type: 'color', defaultValue: '#FF6B00' },
      ],
    },
    {
      ...
      defaultVisible: true,
      fields: [
        { key: 'officeImage', label: 'Ảnh văn phòng', type: 'image', defaultValue: '' },
        { key: 'stats', label: 'Chỉ số', type: 'repeater', fields: [
          { key: 'number', label: 'Số', type: 'text' },
          { key: 'label', label: 'Nhãn', type: 'text' },
          { key: 'icon', label: 'Icon', type: 'icon' },
        ], defaultValue: [
          { number: '100%', label: 'SLA Uptime', icon: 'Shield' },
          { number: 'ISO 27001', label: 'Chứng nhận bảo mật', icon: 'Award' },
          { number: '50+', label: 'Kỹ sư phần mềm', icon: 'Users' },
    ...
    },
    {
      ...
      defaultVisible: true,
      fields: [
        { key: 'title', label: 'Tiêu đề', type: 'text', defaultValue: 'Hành trình phát triển' },
        { key: 'milestones', label: 'Các mốc', type: 'repeater', fields: [
          { key: 'year', label: 'Năm', type: 'text' },
          { key: 'title', label: 'Tiêu đề', type: 'text' },
          { key: 'description', label: 'Mô tả', type: 'textarea' },
        ], defaultValue: [
          { year: '2016', title: 'Khởi đầu', description: 'Thành lập với đội ngũ 5 thành viên đầy nhiệt huyết' },
          { year: '2019', title: 'Mở rộng', description: 'Đạt 100+ khách hàng doanh nghiệp' },
          { year: '2022', title: 'Đột phá', description: 'Ra mắt nền tảng Cloud và hệ sinh thái giải pháp' },
          { year: '2026', title: 'Tầm nhìn', description: 'Vươn tầm khu vực Đông Nam Á' },
        ]},
      ],
    },
    {
